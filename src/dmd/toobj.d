...
void genModuleInfo(Module m)
{
    ...
    for (size_t i = 0; i < m.aimports.dim; i++)
    {
        ...
        // Remove references to module infos that cross a dll boundary.
        // The operating system loader will already handle these dependencies for us.
        if (!mod.needmoduleinfo || mod.isDllImported)
            aimports_dim--;
    }
...
void toObjFile(Dsymbol ds, bool multiobj)
{
    ...
    private:
         ...
         */
        static void tlsToDt(VarDeclaration vd, Symbol *s, uint sz, DtBuilder dtb, Array!DataSymbolRef* dataSymbolRefs)
        {
