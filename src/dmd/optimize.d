    ...
    public:
        ...
        override void visit(AddrExp e)
        {
            ...
            if (e.e1.op == TOKvar)
            {
                ...
                if (!ve.var.isOut() && !ve.var.isRef() && (!global.params.importsDll || ve.var.isFuncDeclaration() || !ve.var.isImportedSymbol()))
                {
            ...
            if (e.e1.op == TOKindex)
            {
                ...
                if (ae.e2.op == TOKint64 && ae.e1.op == TOKvar)
                {
                    ...
                    if (ve.type.ty == Tsarray && (!global.params.importsDll || !ve.var.isImportedSymbol()))
                    {
